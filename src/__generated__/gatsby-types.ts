...
type FileFilterInput = {
  ...
  readonly childrenDataJson: Maybe<DataJsonFilterListInput>;
...
type DataJsonFilterListInput = {
  readonly elemMatch: Maybe<DataJsonFilterInput>;
};
...
type DataJsonFilterInput = {
  ...
  readonly rank: Maybe<IntQueryOperatorInput>;
};
...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.frontmatter.cover.childrenDataJson'
  ...
  | 'childMarkdownRemark.frontmatter.cover.childrenDataJson'
  ...
  | 'childrenDataJson.tag'
  | 'childrenDataJson.name'
  | 'childrenDataJson.url'
  | 'childrenDataJson.rank'
  | 'childDataJson.id'
...
type MarkdownRemarkFieldsEnum =
  ...
  | 'frontmatter.cover.childrenDataJson'
  | 'frontmatter.cover.childrenDataJson.id'
  | 'frontmatter.cover.childrenDataJson.children'
  | 'frontmatter.cover.childrenDataJson.tag'
  | 'frontmatter.cover.childrenDataJson.name'
  | 'frontmatter.cover.childrenDataJson.url'
  | 'frontmatter.cover.childrenDataJson.rank'
  | 'frontmatter.cover.childDataJson.id'
  | 'frontmatter.cover.childDataJson.children'
  | 'frontmatter.cover.childDataJson.tag'
  | 'frontmatter.cover.childDataJson.name'
  | 'frontmatter.cover.childDataJson.url'
  | 'frontmatter.cover.childDataJson.rank'
...
type SportsPostQueryVariables = Exact<{ [key: string]: never; }>;


type SportsPostQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
...
type DoujinPostQueryVariables = Exact<{ [key: string]: never; }>;


type DoujinPostQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'id'>
        & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title'>>, readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>> }
      ) }> } };

type ExternalLinkQueryVariables = Exact<{ [key: string]: never; }>;


type ExternalLinkQuery = { readonly allDataJson: { readonly edges: ReadonlyArray<{ readonly node: Pick<DataJson, 'id' | 'name' | 'rank' | 'tag' | 'url'> }> } };
...
type SeoComponentQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'siteUrl' | 'keywords' | 'description' | 'image' | 'author'>
...
type PageTemplateQuery = { readonly markdownRemark: Maybe<(
...
type IndexLayoutQueryVariables = Exact<{ [key: string]: never; }>;


type IndexLayoutQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description'>> }> };
...
type bioQuery = { readonly file: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, readonly site: Maybe<{ readonly siteMetadata: Maybe<{ readonly social: Maybe<Pick<SiteSiteMetadataSocial, 'github' | 'instagram' | 'twitter'>> }> }> };
