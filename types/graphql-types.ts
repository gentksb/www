...
export type DoujinPostQueryVariables = {};


export type DoujinPostQuery = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'id'>
        & { frontmatter: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'date' | 'title'>
          & { cover: Maybe<{ childImageSharp: Maybe<{ fluid: Maybe<Pick<ImageSharpFluid, 'src'>> }> }> }
...
export type SportsPostQueryVariables = {};


export type SportsPostQuery = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'id'>
        & { frontmatter: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'date' | 'title'>
          & { cover: Maybe<{ childImageSharp: Maybe<{ fluid: Maybe<Pick<ImageSharpFluid, 'src'>> }> }> }
