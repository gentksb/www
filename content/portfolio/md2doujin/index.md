...
つまり『無料』で入稿PDFを作りたかった、と言い換えても良いです。
...
この時点でゲームオーバーと判断して。最終的にはdvipdfmxで出力したモノクロPDF（埋め込み画像は予めグレースケール化済み）をラック出版さんに確認出してOKもらった上で入稿しました。オンデマンド印刷なら場合によっては問題ありませんし、コピ本ならなおさら問題なく発行できます。
